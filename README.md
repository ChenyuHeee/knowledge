...
| 笔记 | 说明 |
|------|------|
| [CNN](ai-ml/cnn.md) | 卷积神经网络，局部感受野、权重共享、平移不变性, CNN → ViT → VLM |
...
| [内核头文件](linux/kernel-headers.md) | Kernel Headers，GPU 驱动编译内核模块所需 |
...
| [VLIW](systems/vliw.md) | 超长指令字，编译器找并行，DSP/AI 加速器 |
...
| [Nginx](web/nginx.md) | 高性能 HTTP 服务器，反向代理，事件驱动架构 |
...
| 笔记 | 说明 |
|------|------|
| [DDoS 攻击](security/ddos.md) | 攻击类型、动机、防御、勒索经济学、匿名支付链路 |
